...
pdf("Luminex.pdf")
ggplot(all_bio, aes(Status2, IL6.basal))+geom_boxplot(aes(fill=Status2))+labs(title="IL-6:  Baseline", x="Responder Status", y="Serum IL-6 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL6.PS1))+geom_boxplot(aes(fill=Status2))+labs(title="IL-6:  Post-Surgery 1", x="Responder Status", y="Serum IL-6 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL6.PS2))+geom_boxplot(aes(fill=Status2))+labs(title="IL-6:  Post-Surgery 2", x="Responder Status", y="Serum IL-6 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL6.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-6:  Post-Surgery 1", x="Responder Status", y="Serum IL-6 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(dall_bio, aes(Status2, IL6.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-6:  Post-Surgery 2", x="Responder Status", y="Serum IL-6 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)

ggplot(all_bio, aes(Status2, IL8.basal))+geom_boxplot(aes(fill=Status2))+labs(title="IL-8:  Baseline", x="Responder Status", y="Serum IL-8 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL8.PS1))+geom_boxplot(aes(fill=Status2))+labs(title="IL-8:  Post-Surgery 1", x="Responder Status", y="Serum IL-8 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL8.PS2))+geom_boxplot(aes(fill=Status2))+labs(title="IL-8:  Post-Surgery 2", x="Responder Status", y="Serum IL-8 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL8.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-8:  Post-Surgery 1", x="Responder Status", y="Serum IL-8 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL8.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-8:  Post-Surgery 2", x="Responder Status", y="Serum IL-8 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)

ggplot(all_bio, aes(Status2, IL10.basal))+geom_boxplot(aes(fill=Status2))+labs(title="IL-10:  Baseline", x="Responder Status", y="Serum IL-10 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL10.PS1))+geom_boxplot(aes(fill=Status2))+labs(title="IL-10:  Post-Surgery 1", x="Responder Status", y="Serum IL-10 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL10.PS2))+geom_boxplot(aes(fill=Status2))+labs(title="IL-10:  Post-Surgery 2", x="Responder Status", y="Serum IL-10 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL10.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-10:  Post-Surgery 1", x="Responder Status", y="Serum IL-10 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, IL10.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="IL-10:  Post-Surgery 2", x="Responder Status", y="Serum IL-10 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)

ggplot(all_bio, aes(Status2, MCP1.basal))+geom_boxplot(aes(fill=Status2))+labs(title="MCP1:  Baseline", x="Responder Status", y="Serum MCP1 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, MCP1.PS1))+geom_boxplot(aes(fill=Status2))+labs(title="MCP1:  Post-Surgery 1", x="Responder Status", y="Serum MCP1 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, MCP1.PS2))+geom_boxplot(aes(fill=Status2))+labs(title="MCP1:  Post-Surgery 2", x="Responder Status", y="Serum MCP1 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, MCP1.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="MCP1:  Post-Surgery 1", x="Responder Status", y="Serum MCP1 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, MCP1.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="MCP1:  Post-Surgery 2", x="Responder Status", y="Serum MCP1 (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)

ggplot(dall_bio, aes(Status2, TNFa.basal))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Baseline", x="Responder Status", y="Serum TNFa (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, TNFa.PS1))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 1", x="Responder Status", y="Serum TNFa (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, TNFa.PS2))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 2", x="Responder Status", y="Serum TNFa (pg/ml)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, TNFa.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 1", x="Responder Status", y="Serum TNFa (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, TNFa.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 2", x="Responder Status", y="Serum TNFa (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)
ggplot(all_bio, aes(Status2, TNFa.PS1.percent))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 1", x="Responder Status", y="Serum TNFa (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)+scale_y_log10()
ggplot(all_bio, aes(Status2, TNFa.PS2.percent))+geom_boxplot(aes(fill=Status2))+labs(title="TNFa:  Post-Surgery 2", x="Responder Status", y="Serum TNFa (% baseline)")+pub_specs+theme(legend.position="none")+scale_fill_brewer(palette="Set1")+geom_jitter(width=0.2)+scale_y_log10()
