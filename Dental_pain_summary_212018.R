...
ggplot(luminex.all, aes(Event, TNFa, group=Status2,color=Status2))+labs(title="TNF-alpha", x="Measurement", y="Serum TNF-alpha (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
...
ggplot(luminex.all, aes(Event, COX.1, group=Status2,color=Status2))+labs(title="COX-1 Activity", x="Measurement", y="Serum Thromboxane B2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(luminex.all, aes(Event, COX.2, group=Status2,color=Status2))+labs(title="COX-2 Activity", x="Measurement", y="Plasma PGE2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
...
png("TNF_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, TNFa, group=Status2,fill=Status2))+labs(title="TNF-alpha: Post-surgery 2", y="Serum TNF-alpha (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("IL6_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, IL6, group=Status2,fill=Status2))+labs(title="IL-6: Post-surgery 2", y="Serum IL-6 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("IL8_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, IL8, group=Status2,fill=Status2))+labs(title="IL-8: Post-surgery 2", y="Serum IL-8 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("IL10_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, IL10, group=Status2,fill=Status2))+labs(title="IL-10: Post-surgery 2", y="Serum IL-10 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("MCP1_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, MCP1, group=Status2,fill=Status2))+labs(title="MCP-1: Post-surgery 2", y="Serum MCP-1 (pg/ml)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGEM_PS1.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"& luminex.all$Status2!="Placebo"),], aes(Status2, PGEM, group=Status2,fill=Status2))+labs(title="PGEM: Post-surgery 1", y="Urinary PGEM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGEM_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, PGEM, group=Status2,fill=Status2))+labs(title="PGEM: Post-surgery 2", y="Urinary PGEM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGIM_PS1.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"& luminex.all$Status2!="Placebo"),], aes(Status2, PGIM, group=Status2,fill=Status2))+labs(title="PGIM: Post-surgery 1", y="Urinary PGIM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGIM_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, PGIM, group=Status2,fill=Status2))+labs(title="PGIM: Post-surgery 2", y="Urinary PGIM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGDM_PS1.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"& luminex.all$Status2!="Placebo"),], aes(Status2, PGDM, group=Status2,fill=Status2))+labs(title="PGDM: Post-surgery 1", y="Urinary PGDM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("PGDM_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, PGDM, group=Status2,fill=Status2))+labs(title="PGDM: Post-surgery 2", y="Urinary PGDM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("TxM_PS1.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"& luminex.all$Status2!="Placebo"),], aes(Status2, TxM, group=Status2,fill=Status2))+labs(title="TxM: Post-surgery 1", y="Urinary TxM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()

png("TxM_PS2.png")
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 2"& luminex.all$Status2!="Placebo"),], aes(Status2, TxM, group=Status2,fill=Status2))+labs(title="TxM: Post-surgery 2", y="Urinary TxM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+geom_boxplot()+geom_jitter(width=0.1)+scale_fill_manual(values = brewer.pal(3, "Set1")[2:3])
dev.off()


ggplot(luminex.all, aes(Status2, IL10, group=Status2,fill=Status2))+labs(title="IL-10", x="Measurement", y="Serum IL-10 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, IL1b, group=Status2,fill=Status2))+labs(title="IL-1beta", x="Measurement", y="Serum IL-1beta (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, IL6, group=Status2,fill=Status2))+labs(title="IL-6", x="Measurement", y="Serum IL-6 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, IL8, group=Status2,fill=Status2))+labs(title="IL-8", x="Measurement", y="Serum IL-8 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, MCP1, group=Status2,fill=Status2))+labs(title="MCP-1", x="Measurement", y="Serum MCP-1 (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, TNFa, group=Status2,fill=Status2))+labs(title="TNF-alpha", x="Measurement", y="Serum TNF-alpha (pg/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)

ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, IL10.percent, group=Status2,fill=Status2))+labs(title="IL-10", x="Measurement", y="Serum IL-10 (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, IL1b.percent, group=Status2,fill=Status2))+labs(title="IL-1beta", x="Measurement", y="Serum IL-1beta (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, IL6.percent, group=Status2,fill=Status2))+labs(title="IL-6", x="Measurement", y="Serum IL-6 (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, IL8.percent, group=Status2,fill=Status2))+labs(title="IL-8", x="Measurement", y="Serum IL-8 (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, MCP1.percent, group=Status2,fill=Status2))+labs(title="MCP-1", x="Measurement", y="Serum MCP-1 (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all[which(luminex.all$Event=="Post-surgery 1"|luminex.all$Event=="Post-surgery 2"),], aes(Status2, TNFa.percent, group=Status2,fill=Status2))+labs(title="TNF-alpha", x="Measurement", y="Serum TNF-alpha (%baseline)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)


ggplot(luminex.all, aes(Status2, COX.1, group=Status2,fill=Status2))+labs(title="COX-1 Activity", x="Measurement", y="Serum Thromboxane B2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, COX.2, group=Status2,fill=Status2))+labs(title="COX-2 Activity", x="Measurement", y="Plasma PGE2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)

ggplot(luminex.all, aes(Status2, PGEM, group=Status2,fill=Status2))+labs(title="PGEM", x="Measurement", y="Urinary PGEM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, PGIM, group=Status2,fill=Status2))+labs(title="PGIM", x="Measurement", y="Urinary PGIM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, PGDM, group=Status2,fill=Status2))+labs(title="PGDM", x="Measurement", y="Urinary PGDM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, TxM, group=Status2,fill=Status2))+labs(title="TxM", x="Measurement", y="Urinary TxM (ng/mg creatinine)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)


ggplot(luminex.all, aes(Status2, COX.1, group=Status2,fill=Status2))+labs(title="COX-1 Activity", x="Measurement", y="Serum Thromboxane B2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(Demo_Gender~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, COX.2, group=Status2,fill=Status2))+labs(title="COX-2 Activity", x="Measurement", y="Plasma PGE2 (ng/ml)")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(Demo_Gender~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
...
ggplot(luminex.all, aes(Status2, PTGS1, group=Status2,fill=Status2))+labs(title="PTGS1", x="Measurement", y="PTGS1/GAPDH")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)
ggplot(luminex.all, aes(Status2, PTGS2, group=Status2,fill=Status2))+labs(title="PTGS2", x="Measurement", y="PTGS2/GAPDH")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_boxplot()+facet_grid(.~Event)+theme(axis.text.x=element_text(angle=-45, hjust=0))+ geom_jitter(width=0.1)

ggplot(luminex.all, aes(PTGS2,PGIM, group=Status2,fill=Status2))+labs(title="PTGS2", y="Urinary PGIM (ng/mg creatinine)", x="PTGS2/GAPDH")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+geom_point()+facet_grid(Demo_Gender~.)

ggplot(luminex.all[which(luminex.all$Event=="Baseline"|luminex.all$Status2=="Placebo"),], aes(PTGS2,PGIM, color=Event, shape=Demo_Gender))+geom_point()+pub_specs

luminex.nodrug=luminex.all[which(luminex.all$Event=="Baseline"|luminex.all$Status2=="Placebo"),]
luminex.men=luminex.nodrug[which(luminex.nodrug$Demo_Gender=="1"),]
luminex.women=luminex.nodrug[which(luminex.nodrug$Demo_Gender=="2"),]
cor(luminex.nodrug$PTGS2,luminex.nodrug$PGIM, use="complete.obs",method="spearman")
cor(luminex.men$PTGS2,luminex.men$PGIM, use="complete.obs",method="spearman")
cor(luminex.women$PTGS2,luminex.women$PGIM, use="complete.obs",method="spearman")
write.csv(luminex.nodrug,"Dental_Pain_nodrug.csv")
...
ggplot(pain_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Pain Score", x="Measurement", y="Pain Score")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)

ggplot(insula_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Insula", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(S1_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="S1", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(S2_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="S2", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(thalamus_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Thalamus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(ACC_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="ACC", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(amygdala_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Amygdala", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(hippocampus_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Hippocampus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(parahippocampus_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Parahippocampus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))
ggplot(pain_resp_melt, aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+facet_grid(Status2~.)+labs(title="Pain Score", x="Measurement", y="Pain Score")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)+geom_point(aes(group=Status2))

ggplot(insula_resp_melt[which(insula_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Insula", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(S1_resp_melt[which(S1_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="S1", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(S2_resp_melt[which(S2_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="S2", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(thalamus_resp_melt[which(thalamus_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Thalamus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(ACC_resp_melt[which(ACC_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="ACC", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(amygdala_resp_melt[which(amygdala_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Amygdala", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(hippocampus_resp_melt[which(hippocampus_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Hippocampus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(parahippocampus_resp_melt[which(parahippocampus_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Parahippocampus", x="Measurement", y="rCBF")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
ggplot(pain_resp_melt[which(pain_resp_melt$Status2!="Placebo"),], aes(Time, as.numeric(rCBF), group=Status2,color=Status2))+labs(title="Pain Score", x="Measurement", y="Pain Score")+pub_specs+theme(legend.position="none")+scale_color_brewer(palette="Set1")+scale_fill_brewer(palette="Set1")+stat_summary(fun.y="median",fun.ymin="Q1",fun.ymax="Q3", size=2, geom="smooth", aes(fill=Status2), alpha=0.3)
